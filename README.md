...
> لا يُخزَّن أي نص مصدر ديني داخل المستودع — المحتوى المعتمد موجود فقط في
> قاعدة البيانات الحيّة. ولا يستشهد المساعد بأي سجلّ إلا إذا حمل `authority`
> و`verificationStatus == "verified"`. راجع `docs/ARCHITECTURE.md` قسم
> "Approved source registry" لتفاصيل المخطّط وعملية التوثيق.
