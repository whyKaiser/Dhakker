...
class HajjScheduleService {
  ...
  static const Map<int, List<_Reminder>> _schedule = {
    8: [
      _Reminder(6, 0, 'يوم التروية', 'اليوم الثامن — استعدّ للإحرام والتوجه إلى منى'),
      _Reminder(10, 0, 'المبيت في منى', 'السنة البيتوتة في منى هذه الليلة'),
    ],
    9: [
      _Reminder(6, 0, 'يوم عرفة', '🌄 ركن الحج الأعظم — توجّه لعرفات قبل الظهر'),
      _Reminder(12, 0, 'وقفة عرفة', '🤲 الآن في أشرف موقف — أكثر من الدعاء والذكر'),
      _Reminder(17, 30, 'الدفع من عرفة', '🚶 بعد غروب الشمس ادفع باتجاه مزدلفة'),
    ],
    10: [
      _Reminder(5, 0, 'يوم النحر', '🗓 رمي جمرة العقبة بعد الفجر'),
      _Reminder(8, 0, 'طواف الإفاضة', '🕋 ركن الحج — اتجه للمسجد الحرام للطواف'),
      _Reminder(14, 0, 'السعي', '🏃 اسعَ بين الصفا والمروة بعد طواف الإفاضة'),
    ],
    11: [
      _Reminder(12, 30, 'رمي الجمرات', '🪨 بعد الزوال — الصغرى ثم الوسطى ثم الكبرى (العقبة)'),
    ],
    12: [
      _Reminder(12, 30, 'رمي الجمرات', '🪨 آخر أيام التشريق الإلزامية — الصغرى ثم الوسطى ثم الكبرى'),
    ],
    13: [
      _Reminder(7, 0, 'طواف الوداع', '🕋 آخر عهدك بالكعبة — لا تنسَ طواف الوداع قبل السفر'),
    ],
  };
